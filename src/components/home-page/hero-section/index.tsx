...
const HeroSection = () => {
  return (
    <div className="px-4 md:px-8 pt-10 md:pt-20 container  ">
      ...
      <div className=" bg-[#D43642] w-full max-w-[1801px] h-[450px] md:h-[460px] mx-auto mt-10 mb-2 rounded-2xl relative px-6 flex flex-col md:flex-row justify-between items-center">
